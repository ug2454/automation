...
When BBNMS accept ISAAC Process Hardware request
...
And Activate Services in UDAS task should be successful in OL
And Retrieve WOLI Info from AHL task should be successful in OL
Then validate woli response contains Productname2 INTERNAL WIRELESS VIDEO BRIDGE
...
And Activate Services in UDAS task should be successful in OL
And Retrieve WOLI Info from AHL task should be successful in OL
Then validate woli response contains Productname1 MOBILE DVR
...
And Activate Services in UDAS task should be successful in OL
And Retrieve WOLI Info from AHL task should be successful in OL
Then validate woli response contains Productname REVERSE BAND 5