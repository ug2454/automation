...
@Component
@Qualifier("ShellUtilCimApp")
public class ShellUtilCimApp extends BBNMSService
{

   private ShellClient shellUtil;

   public ShellUtilCimApp(@Value("${" + EnvConstants.BBNMS_CIMAPP_HOSTNAME + "}") String hostname, @Value("${"
